...
### Ответ
Отработает. CoroutineScope и supervisorScope сами по себе корутин не создают, внутри этих блоков дочерних корутин нет, а на обработку исключений в родительской они никак не влияют.
